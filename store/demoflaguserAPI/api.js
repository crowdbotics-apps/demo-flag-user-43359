...
const demoflaguserAPI = axios.create({
  baseURL: "https://demo-flag-user-43359.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_docs_schema_retrieve(payload) {
  return demoflaguserAPI.get(`/api-docs/schema/`, {
    params: { lang: payload.lang }
  })
}
function api_v1_login_create(payload) {
  return demoflaguserAPI.post(`/api/v1/login/`, payload.data)
}
...
function rest_auth_logout_retrieve(payload) {
  return demoflaguserAPI.get(`/rest-auth/logout/`)
}
function rest_auth_logout_create(payload) {
  return demoflaguserAPI.post(`/rest-auth/logout/`)
}
function rest_auth_password_change_create(payload) {
  return demoflaguserAPI.post(`/rest-auth/password/change/`, payload.data)
}
function rest_auth_password_reset_create(payload) {
  return demoflaguserAPI.post(`/rest-auth/password/reset/`, payload.data)
}
function rest_auth_password_reset_confirm_create(payload) {
  return demoflaguserAPI.post(
    `/rest-auth/password/reset/confirm/`,
    payload.data
  )
}
function rest_auth_registration_create(payload) {
  return demoflaguserAPI.post(`/rest-auth/registration/`, payload.data)
}
...
function rest_auth_user_retrieve(payload) {
  return demoflaguserAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(payload) {
  return demoflaguserAPI.put(`/rest-auth/user/`, payload.data)
}
function rest_auth_user_partial_update(payload) {
  return demoflaguserAPI.patch(`/rest-auth/user/`, payload.data)
}
